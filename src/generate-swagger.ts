...
async function generateSwagger() {
  ...
  try {
    // Create a comprehensive Swagger document based on the API structure
        ...
        schemas: {
          App: {
            ...
            properties: {
              ...
              description: { type: 'string', example: 'A sample application' },
              repositoryUrl: { type: 'string', example: 'https://github.com/user/my-app' },
          ...
          Deployment: {
            ...
            properties: {
              ...
              url: { type: 'string', example: 'https://my-app.cloudfuse.com' },
              createdAt: { type: 'string', format: 'date-time' },
              updatedAt: { type: 'string', format: 'date-time' },
            },
          },
          CreateDeploymentDto: {
            type: 'object',
            properties: {
              appId: { type: 'string', example: '123e4567-e89b-12d3-a456-426614174000' },
              version: { type: 'string', example: '1.0.0' },
          ...
          Container: {
            ...
            properties: {
              id: { type: 'string', example: '123e4567-e89b-12d3-a456-426614174000' },
              name: { type: 'string', example: 'my-container' },
              containerId: { type: 'string', example: 'abc123def456' },
              type: { type: 'string', enum: ['docker', 'kubernetes'], example: 'docker' },
              status: { 
                type: 'string', 
    ...
    writeFileSync('./swagger.yaml', dump(swaggerDocument));
    ...
    console.log('📖 This documentation includes:');
